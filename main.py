    ...
    while True:
        ...
        if results:
            for i in results:
                ...
                label4 = Label(f2, text="                            ", font=("arial", 10, "bold"), bg="grey16",
                               fg="white")
                label4.pack(side=BOTTOM, fill=X)
                statusbar = Label(f1, text="                            ", font=("arial", 8, "bold"),
                ...
                label4 = Label(f3, text="                            ", font=("arial", 10, "bold"), bg="grey16",
                               fg="white")
                label4.pack(side=BOTTOM, fill=X)
                ...
                label11 = Label(f4, text="     ", font=("arial", 10, "bold"), bg="grey16",
                                fg="white")
